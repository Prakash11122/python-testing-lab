...
print("Number of rows is :",noOfRows) #Number of rows is : 7
print("Number of columns is ",noOfColumns) #Number of columns is  4

# 2) Read specific row & Column data
readSpecificRow=driver.find_element(By.XPATH,"//table[@name='BookTable']//tr[4]/td[1]").text

print(readSpecificRow)
